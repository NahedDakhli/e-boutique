			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							<label class="control-label col-md-4">Prix unitaire
							</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4">Télécharger une image</label>
							<div class="col-md-8">
							...
							<div class="col-md-8">
								...
								<div class="text-right">
									...
									<button type="button" class="btn btn-warning btn-xs"
										data-toggle="modal" data-target="#myCategoryModal">Ajouter une nouvelle catégorie</button>
								</div>
							</div>
				...
				<div class="modal-body">
					...
					<sf:form id="categoryForm" class="form-horizontal"
						...
						<div class="form-group">
							...
							<div class="col-md-8 validate">
								<sf:textarea path="description" class="form-control"
									placeholder="Entrez la description de la catégorie ici!" />
							</div>
						</div>
