...
<%@taglib prefix="sf" uri="http://www.springframework.org/tags/form" %>			
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						>
							...
							<div class="form-group">
								<label class="control-label col-md-4">Numéro de téléphone</label>
								<div class="col-md-8">
	...
	<div class="form-group">
		<label class="control-label col-md-4">Sélectionnez le rôle</label>
		<div class="col-md-8">
			<label class="radio-inline">
				<sf:radiobutton path="role" value="USER" checked="checked"/> Client 				
			</label>
			<label class="radio-inline">
				<sf:radiobutton path="role" value="SUPPLIER"/> Vendeur
			</label>
		</div>
	</div>							
